...
public class ApiExceptionHandler {
    ...
    public ResponseEntity<ProblemDetail> handleMethodValidation(
        ...
        List<Map<String, Object>> errors = switch (exception) {
            case HandlerMethodValidationException methodException ->
                    methodException.getAllErrors()
                            .stream()
                            .map(this::methodValidationError)
                            .toList();
    ...
    private Map<String, Object> methodValidationError(
    ...
    private ResponseEntity<ProblemDetail> problem(
        ...
        problem.setType(
                URI.create("urn:minimarket:error:" + code.toLowerCase())
        );
